...
# This should yield PD Theta.P and M matrices.
# M should have size 1000x1000.
...
\begin{itemize}
    ...
    \item \texttt{M}: A square matrix representing the kinship-based relatedness matrix for individuals.
    ...
    \item \texttt{formula}: A formula specifying the model structure for the Bayesian mixed-effects model. Default is \texttt{"Y \textasciitilde{} 1 + (1 | gr(pop, cov = two.Theta.P)) + (1 | gr(ind, cov = M))"}.
