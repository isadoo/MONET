...
\begin{itemize}
\item Increase \texttt{adapt\_delta} (e.g., \texttt{control = list(adapt\_delta = 0.95)}) to hopefully reduce the number of divergent transitions
\item Increase \texttt{iter} and \texttt{warmup} parameters to increase the length of the algorithm allowed for it to reach a convergent state
