...
**We welcome your feedback!** If you have suggestions, questions, or find any issues, please reach out via our [GitHub Issues page](https://github.com/isadoo/LAVA/issues) or contact isabela[dot]doo[at]unil[dot]ch
...
We recommend starting with the comprehensive tutorial vignette to learn how to use LAVA effectively. The tutorial includes detailed explanations of the method, step-by-step examples, and guidance on interpreting results.

You can find the tutorial in the [vignettes folder](vignettes/vignette_main.pdf) of the GitHub repository.

## Example

Here is a basic example showing how to use LAVA:
...
- Our [GitHub repository](https://github.com/isadoo/LAVA)

## Contributing

We welcome contributions! Please reach out via our [GitHub Issues page](https://github.com/isadoo/LAVA/issues) if you'd like to contribute or have suggestions.
