...
#' This dataset is used in the MONET package vignette to demonstrate
...
#' from 18 populations. This neutral trait dataset is used in the MONET package
...
#' (i.e., no local adaptation) and is used to demonstrate the MONET method's
...
#'
#' This matrix is used as input to the monet() function to model between-population
...
#' }
#'
#' The matrix is used as input to the monet() function to model within-population
...
#' # Load the data
#' M <- readRDS(
#'   system.file("extdata", "vignette_The_M.rds", package = "MONET")
#' )
#' 
#' # Check dimensions
#' dim(M)
...
#' Vignette MONET Results
#'
#' @name vignette_monet_results
#' @docType data
#'
#' @description
#' An example output object from the monet() function, demonstrating the
#' structure and content of MONET analysis results. This object contains
#' posterior samples, log-ratio estimates, and convergence diagnostics.
#'
#' @format A list of class "monet" with the following components:
#' \describe{
...
#'
#' @usage data(vignette_monet_results)
#'
#' @examples
#' \dontrun{
#' # Load the results
#' results <- readRDS(
#'   system.file("extdata", "vignette_monet_results.rds", package = "MONET")
#' )
#' 
#' # Print summary
#' print(results)
...
#' }
#'
#' @seealso \code{\link{monet}} for generating these results
#' @source Generated by running monet() on vignette example data
#' @keywords datasets
NULL
...
#'
#' @usage 
#' system.file("extdata", "neutral_data_g3000.dat", package = "MONET")
#'
#' @examples
#' \dontrun{
#' # Read the data
...
#'
#' @usage 
#' system.file("extdata", "quanti_trait_g3000.dat", package = "MONET")
#'
#' @examples
#' \dontrun{
#' # Read the data
...
#'   system.file("extdata", "vignette_dosage_quanti_F1.rds", package = "MONET")
#' )
#' 
#' # Check dimensions
